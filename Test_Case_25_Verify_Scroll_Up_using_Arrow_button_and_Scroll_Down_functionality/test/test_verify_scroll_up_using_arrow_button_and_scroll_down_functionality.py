...
@allure.feature("Verify scroll up using arrow button and scroll down functionality")
@allure.story("End to End verify scroll up using arrow button and scroll down functionality")
@allure.title("Test E2E verify scroll up using arrow button and scroll down functionality")
def test_verify_scroll_up_using_arrow_button_and_scroll_down_functionality(pages):
    ...
    with allure.step("Step 6: Click on arrow at bottom right side to move upward"):
        pages.home_page.click_scroll_up_button()
