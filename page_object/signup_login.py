...
class SignupLogin(BrowserUtils):
    ...
    def verify_new_user_signup_text(self):
        element \
            = self.wait.until(expected_conditions.visibility_of_element_located(self.new_user_sign_up_text))
    ...
    def verify_login_page_text(self):
        login_page_element \
            = self.wait.until(expected_conditions.visibility_of_element_located(self.login_page_text))
    ...
    def account_exist_text(self):
        info = self.wait.until(expected_conditions.visibility_of_element_located(self.account_exist_info))
    ...
    def full_register_process(self, data: dict):
        ...
        self.register.fill_account_information(data)
        self.register.fill_address_information(data)
        self.register.click_create_account_button()

     # 登入
    def full_login_process(self, data: dict):
        self.fill_login_page(data)
